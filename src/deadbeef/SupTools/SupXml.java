...
import deadbeef.SupTools.Core.Resolution;
 ...
 * @author 0xdeadbeef
 */
class SupXml implements Substream {
	 ...
	 */
	SupXml(final String fn) throws CoreException {
	 ...
	 * @throws CoreException
	 */
	static void writeXml(final String fname, final SubPicture pics[]) throws CoreException {
	 ...
	 * @return PNG name
	 */
	static String getPNGname(final String fn, final int idx) {
