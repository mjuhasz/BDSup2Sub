...
public class Core extends Thread {
    ...
    public static void readSup(String fname) throws CoreException {
        ...
        if (id != null && id[0] == 0x50 && id[1] == 0x47) {
            supBD = new SupBD(fname, BDSup2SubCoreManager.getInstance());
            subtitleStream = supBD;
            supHD = null;
            inMode = InputMode.BDSUP;
        } else {
            supHD = new SupHD(fname, BDSup2SubCoreManager.getInstance());
    ...
    public static void readXml(String fname) throws CoreException {
        ...
        supXml = new SupXml(fname, BDSup2SubCoreManager.getInstance());
    ...
    private static void readDVDSubstream(String fname, boolean isVobSub) throws CoreException {
        ...
        if (isVobSub) {
            ...
            subDVD = new SubDvd(fnS, fnI, BDSup2SubCoreManager.getInstance());
            ...
            supDVD = new SupDvd(fnS, fnI, BDSup2SubCoreManager.getInstance());
